...
.ddm-usage { display: flex; align-items: center; gap: 8px; min-height: 18px; line-height: 18px; }
.ddm-usage-label { flex: 0 0 auto; color: var(--dsw-alias-label-tertiary, #9aa0aa); }
.ddm-usage-meter {
  flex: 1 1 auto;
  height: 5px;
  border-radius: 3px;
